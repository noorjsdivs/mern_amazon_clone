...
const ProductPage = async ({ params }: any) => {
     ...
     // @ts-ignore
     const product: ProductType = await getFetchData(endpoint);

     return (
          <div className="py-10 px-4 lg:px-0">
               <h1 className="text-center mb-8 lg:text-4xl text-2xl text-cyan-600 font-medium tracking-wide">Single Product Page</h1>
               <Container className={"flex flex-col lg:flex-row justify-between gap-6 border-2  border-gray-300"}>
                    {/* Image Section */}
                    <div>
